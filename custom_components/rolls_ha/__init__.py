...
async def _generate_dashboard(hass: HomeAssistant, entry: ConfigEntry) -> None:
    ...
    for cover_eid in covers_list:
        ...
        cover_blocks.append(
            ...
            f"        entity: {sn_status}\n"
            f"        attribute: pozitie\n"
            f"        name: \"Poziție curentă (%)\"\n"
            f"        icon: mdi:percent\n"
            f"      - type: attribute\n"
            f"        entity: {sn_status}\n"
            f"        attribute: stare_cover\n"
            f"        name: \"Stare cover\"\n"
            f"        icon: mdi:window-shutter\n"
            f"      - type: attribute\n"
            f"        entity: {sn_status}\n"
            f"        attribute: este_deschisa\n"
            f"        name: \"Este deschisă\"\n"
            f"        icon: mdi:check-circle\n"
            f"      - type: attribute\n"
            f"        entity: {sn_status}\n"
    ...
    content = (
        ...
        f"\n"
        f"  # ════════════════════════════════════════════════════════════════════\n"
        f"  # JALUZELE ({len(covers_list)} configurate)\n"
        f"  # ════════════════════════════════════════════════════════════════════\n"
        f"{covers_yaml}\n"
